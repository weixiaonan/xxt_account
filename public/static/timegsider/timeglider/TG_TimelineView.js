	...
	*/
	...
	this._templates = {
        ...
        settings_modal : $.template( null,
          ...
          "<div class='tg-legend-controls'><span class='tg-legend-all'>显示全部</span><span class='tg-legend-none'> | 隐藏全部</span></div>"+
          "</div>"+
          "</div>")
  ...
  registerTitles: function () {
	...
	setupPresentation: function() {
		...
		var title = "<h2 id='pres_title' class='no-select' data-timeline_id='primary'>" + pres.title + "</h2>",
			...
			leg = (pres.legend) ? "<li id='legend' data-timeline_id='pres' class='tg-legend-bt'>�յ�</li>":"",
